import { DeliverEntityAction, MessageAction, WarningBarAction, WorldEventAction } from "../../classes/world/events/event-action.js";
...
TypeRegistries.worldevent.add("action.warn-bar", WarningBarAction);

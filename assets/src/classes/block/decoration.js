...
class SignBlock extends Block {
  ...
  drawTooltip(x, y, outline, background) {
    MLF1.draw(x, y, this._message.replaceAll("\\n", "\n"), null, Item.getColourFromRarity(0, "light"));
  }
  getMsg() {
    return this._message;
  }
  highlight(emphasised) {
    (super.highlight(emphasised), this.drawTooltip(this.uiX + blockSize * 0.5 * ui.camera.zoom, this.uiY - blockSize * 0.5 * ui.camera.zoom));
  }
